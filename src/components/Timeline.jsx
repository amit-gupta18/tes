      ...
      >
        <div className="mx-auto flex max-w-6xl flex-col gap-10 lg:flex-row">
          ...
          <div className="flex-1">
            {/* Section heading */}
            <header ref={headerRef} className="mb-8 timeline-animate">
              <p
                ...
                {agenda.map((item, index) => {
                  ...
                  return (
                    <li
                      ...
                      className="relative flex gap-4 sm:gap-6 timeline-animate"
          ...
          <aside ref={sidebarRef} className="w-full max-w-sm self-start space-y-4 lg:space-y-5 sidebar-animate">
            {/* QR card */}
